    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('provider', models.PositiveIntegerField(choices=[(0, 'GOOGLE'), (1, 'APPLE'), (2, 'PHONE'), (3, 'FACEBOOK'), (4, 'INSTAGRAM'), (5, 'VK'), (6, 'WECHAT')])),
                ('social_id', models.CharField(max_length=255)),
                ('gender', models.PositiveIntegerField(blank=True, choices=[(0, 'Man'), (1, 'Woman'), (2, 'Other')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_decoded_token', models.JSONField(blank=True, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
